...
[![Platform](https://img.shields.io/badge/platform-linux--mint%20%7C%20ubuntu-green.svg)](https://linuxmint.com/)
...
Asegúrate de tener instalado **Python 3.8** o superior. Puedes verificarlo en tu terminal:
```bash
python3 --version
